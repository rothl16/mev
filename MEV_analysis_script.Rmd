...
df_all <- rbind(df_ge,df_me, df_ne,df_sa)
```
...
#Netherlands
cg_ne <- as.data.frame(report::report(t.test(df_ne$core_good_lo, df_ne$core_good_he, paired = TRUE)))
cg_ne <- cg_ne %>% select(p, Cohens_d, Cohens_d_CI_low, Cohens_d_CI_high)
cg_ne$BF <- as.data.frame(ttestBF(x = df_ne$core_good_lo, y = df_ne$core_good_he, paired = TRUE))[1]

#South Africa
cg_sa <- as.data.frame(report::report(t.test(df_sa$core_good_lo, df_sa$core_good_he, paired = TRUE)))
cg_sa <- cg_sa %>% select(p, Cohens_d, Cohens_d_CI_low, Cohens_d_CI_high)
cg_sa$BF <- as.data.frame(ttestBF(x = df_sa$core_good_lo, y = df_sa$core_good_he, paired = TRUE))[1]

#combine results
cg_results <- bind_rows(cg_all, cg_ge, cg_me, cg_ne, cg_sa) #using more flexible dplyr function; rbind had trouble with row.names
...
vc_all$BF <- as.data.frame(ttestBF(x = df_all$core_good_lo, y = df_all$core_good_he, paired = TRUE))[1]
...
vc_ge$BF <- as.data.frame(ttestBF(x = df_ge$core_good_lo, y = df_ge$core_good_he, paired = TRUE))[1]
...
vc_me$BF <- as.data.frame(ttestBF(x = df_me$core_good_lo, y = df_me$core_good_he, paired = TRUE))[1]

#Netherlands
vc_ne <- as.data.frame(report::report(t.test(df_ne$value_comm_lo, df_ne$value_comm_he, paired = TRUE)))
vc_ne <- vc_ne %>% select(p, Cohens_d, Cohens_d_CI_low, Cohens_d_CI_high)
vc_ne$BF <- as.data.frame(ttestBF(x = df_ne$core_good_lo, y = df_ne$core_good_he, paired = TRUE))[1]

#South Africa
vc_sa <- as.data.frame(report::report(t.test(df_sa$value_comm_lo, df_sa$value_comm_he, paired = TRUE)))
vc_sa <- vc_sa %>% select(p, Cohens_d, Cohens_d_CI_low, Cohens_d_CI_high)
vc_sa$BF <- as.data.frame(ttestBF(x = df_sa$core_good_lo, y = df_sa$core_good_he, paired = TRUE))[1]

#combine results
vc_results <- bind_rows(vc_all, vc_ge, vc_me, vc_ne, vc_sa)
...
pd_all$BF <- as.data.frame(ttestBF(x = df_all$core_good_lo, y = df_all$core_good_he, paired = TRUE))[1]
...
pd_ge$BF <- as.data.frame(ttestBF(x = df_ge$core_good_lo, y = df_ge$core_good_he, paired = TRUE))[1]
...
pd_me$BF <- as.data.frame(ttestBF(x = df_me$core_good_lo, y = df_me$core_good_he, paired = TRUE))[1]

#Netherlands
pd_ne <- as.data.frame(report::report(t.test(df_ne$pay_deservingness_lo, df_ne$pay_deservingness_he, paired = TRUE)))
pd_ne <- pd_ne %>% select(p, Cohens_d, Cohens_d_CI_low, Cohens_d_CI_high)
pd_ne$BF <- as.data.frame(ttestBF(x = df_ne$core_good_lo, y = df_ne$core_good_he, paired = TRUE))[1]

#South Africa
pd_sa <- as.data.frame(report::report(t.test(df_sa$pay_deservingness_lo, df_sa$pay_deservingness_he, paired = TRUE)))
pd_sa <- pd_sa %>% select(p, Cohens_d, Cohens_d_CI_low, Cohens_d_CI_high)
pd_sa$BF <- as.data.frame(ttestBF(x = df_sa$core_good_lo, y = df_sa$core_good_he, paired = TRUE))[1]

#combine results
pd_results <- bind_rows(pd_all, pd_ge, pd_me, pd_ne,pd_sa)
...
wa_all$BF <- as.data.frame(ttestBF(x = df_all$core_good_lo, y = df_all$core_good_he, paired = TRUE))[1]
...
wa_ge$BF <- as.data.frame(ttestBF(x = df_ge$core_good_lo, y = df_ge$core_good_he, paired = TRUE))[1]
...
wa_me$BF <- as.data.frame(ttestBF(x = df_me$core_good_lo, y = df_me$core_good_he, paired = TRUE))[1]

#Netherlands
wa_ne <- as.data.frame(report::report(t.test(df_ne$warmth_lo, df_ne$warmth_he, paired = TRUE)))
wa_ne <- wa_ne %>% select(p, Cohens_d, Cohens_d_CI_low, Cohens_d_CI_high)
wa_ne$BF <- as.data.frame(ttestBF(x = df_ne$core_good_lo, y = df_ne$core_good_he, paired = TRUE))[1]

#South Africa
wa_sa <- as.data.frame(report::report(t.test(df_sa$warmth_lo, df_sa$warmth_he, paired = TRUE)))
wa_sa <- wa_sa %>% select(p, Cohens_d, Cohens_d_CI_low, Cohens_d_CI_high)
wa_sa$BF <- as.data.frame(ttestBF(x = df_sa$core_good_lo, y = df_sa$core_good_he, paired = TRUE))[1]

#combine results
wa_results <- bind_rows(wa_all, wa_ge, wa_me, wa_ne, wa_sa)
...
co_all$BF <- as.data.frame(ttestBF(x = df_all$core_good_lo, y = df_all$core_good_he, paired = TRUE))[1]
...
co_ge$BF <- as.data.frame(ttestBF(x = df_ge$core_good_lo, y = df_ge$core_good_he, paired = TRUE))[1]
...
co_me$BF <- as.data.frame(ttestBF(x = df_me$core_good_lo, y = df_me$core_good_he, paired = TRUE))[1]

#Netherlands
co_ne <- as.data.frame(report::report(t.test(df_ne$competence_lo, df_ne$competence_he, paired = TRUE)))
co_ne <- co_ne %>% select(p, Cohens_d, Cohens_d_CI_low, Cohens_d_CI_high)
co_ne$BF <- as.data.frame(ttestBF(x = df_ne$core_good_lo, y = df_ne$core_good_he, paired = TRUE))[1]

#South Africa
co_sa <- as.data.frame(report::report(t.test(df_sa$competence_lo, df_sa$competence_he, paired = TRUE)))
co_sa <- co_sa %>% select(p, Cohens_d, Cohens_d_CI_low, Cohens_d_CI_high)
co_sa$BF <- as.data.frame(ttestBF(x = df_sa$core_good_lo, y = df_sa$core_good_he, paired = TRUE))[1]

#combine results
co_results <- bind_rows(co_all, co_ge, co_me, co_ne,co_sa)
...
###function doesnt work, do manually!


####################################################
plot_cg <- plot_violin_with_means(df_plot, c("core_good_lo", "core_good_he"), "country", "core goodness")

plot_vc <- plot_violin_with_means(df_plot, c("value_comm_lo", "value_comm_he"), "country", "value commitment")

plot_pd <- plot_violin_with_means(df_plot, c("pay_deservingness_lo", "pay_deservingness_he"), "country","pay deservingness")

plot(plot_pd)

plot_wa <- plot_violin_with_means(df_plot, c("warmth_lo", "warmth_he"), "country", "warmth")

plot_co <- plot_violin_with_means(df_plot, c("competence_lo", "competence_he"), "country", "competence")



combined_plot <- plot_cg / plot_vc / plot_pd / plot_wa / plot_co
...
```{r}
df_long <- pivot_longer(df_plot, cols = c(pay_deservingness_he,pay_deservingness_lo),names_to = "group", values_to = "value")
