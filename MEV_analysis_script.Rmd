...
```{r}
#all
cg_all <- as.data.frame(report::report(t.test(df_all$core_good_lo, df_all$core_good_he, paired = TRUE, alternative = "greater"))) #this computes the paired t-test and saves the results as dataframe
...
cg_all$BF <- as.data.frame(ttestBF(x = df_all$core_good_lo, y = df_all$core_good_he, paired = TRUE, alternative = "greater"))[[1]] #this computes the Bayes Factor of the test and binds it to the other data; this is done for all tests in the same manner

#Germany
cg_ge <- as.data.frame(report::report(t.test(df_ge$core_good_lo, df_ge$core_good_he, paired = TRUE, alternative = "greater")))
cg_ge <- cg_ge %>% select(p, Cohens_d, Cohens_d_CI_low, Cohens_d_CI_high)
cg_ge$BF <- as.data.frame(ttestBF(x = df_ge$core_good_lo, y = df_ge$core_good_he, paired = TRUE, alternative = "greater"))[[1]]

#Mexico
cg_me <- as.data.frame(report::report(t.test(df_me$core_good_lo, df_me$core_good_he, paired = TRUE, alternative = "greater")))
cg_me <- cg_me %>% select(p, Cohens_d, Cohens_d_CI_low, Cohens_d_CI_high)
cg_me$BF <- as.data.frame(ttestBF(x = df_me$core_good_lo, y = df_me$core_good_he, paired = TRUE, alternative = "greater"))[[1]]
...
```{r}
#all
vc_all <- as.data.frame(report::report(t.test(df_all$value_comm_lo, df_all$value_comm_he, paired = TRUE, alternative = "greater")))
vc_all <- vc_all %>% select(p, Cohens_d, Cohens_d_CI_low, Cohens_d_CI_high)
vc_all$BF <- as.data.frame(ttestBF(x = df_all$value_comm_lo, y = df_all$value_comm_he, paired = TRUE, alternative = "greater"))[[1]]

#Germany
vc_ge <- as.data.frame(report::report(t.test(df_ge$value_comm_lo, df_ge$value_comm_he, paired = TRUE, alternative = "greater")))
vc_ge <- vc_ge %>% select(p, Cohens_d, Cohens_d_CI_low, Cohens_d_CI_high)
vc_ge$BF <- as.data.frame(ttestBF(x = df_ge$value_comm_lo, y = df_ge$value_comm_he, paired = TRUE, alternative = "greater"))[[1]]

#Mexico
vc_me <- as.data.frame(report::report(t.test(df_me$value_comm_lo, df_me$value_comm_he, paired = TRUE, alternative = "greater")))
vc_me <- vc_me %>% select(p, Cohens_d, Cohens_d_CI_low, Cohens_d_CI_high)
vc_me$BF <- as.data.frame(ttestBF(x = df_me$value_comm_lo, y = df_me$value_comm_he, paired = TRUE, alternative = "greater"))[[1]]
...
```{r}
#all
pd_all <- as.data.frame(report::report(t.test(df_all$pay_deservingness_lo, df_all$pay_deservingness_he, paired = TRUE, alternative = "greater")))
pd_all <- pd_all %>% select(p, Cohens_d, Cohens_d_CI_low, Cohens_d_CI_high)
pd_all$BF <- as.data.frame(ttestBF(x = df_all$pay_deservingness_lo, y = df_all$pay_deservingness_he, paired = TRUE, alternative = "greater"))[[1]]

#Germany
pd_ge <- as.data.frame(report::report(t.test(df_ge$pay_deservingness_lo, df_ge$pay_deservingness_he, paired = TRUE, alternative = "greater")))
pd_ge <- pd_ge %>% select(p, Cohens_d, Cohens_d_CI_low, Cohens_d_CI_high)
pd_ge$BF <- as.data.frame(ttestBF(x = df_ge$pay_deservingness_lo, y = df_ge$pay_deservingness_he, paired = TRUE, alternative = "greater"))[[1]]

#Mexico
pd_me <- as.data.frame(report::report(t.test(df_me$pay_deservingness_lo, df_me$pay_deservingness_he, paired = TRUE, alternative = "greater")))
pd_me <- pd_me %>% select(p, Cohens_d, Cohens_d_CI_low, Cohens_d_CI_high)
pd_me$BF <- as.data.frame(ttestBF(x = df_me$pay_deservingness_lo, y = df_me$pay_deservingness_he, paired = TRUE, alternative = "greater"))[[1]]
...
```{r}
#all
wa_all <- as.data.frame(report::report(t.test(df_all$warmth_lo, df_all$warmth_he, paired = TRUE, alternative = "less")))
wa_all <- wa_all %>% select(p, Cohens_d, Cohens_d_CI_low, Cohens_d_CI_high)
wa_all$BF <- as.data.frame(ttestBF(x = df_all$warmth_lo, y = df_all$warmth_he, paired = TRUE, alternative = "less"))[[1]]

#Germany
wa_ge <- as.data.frame(report::report(t.test(df_ge$warmth_lo, df_ge$warmth_he, paired = TRUE, alternative = "less")))
wa_ge <- wa_ge %>% select(p, Cohens_d, Cohens_d_CI_low, Cohens_d_CI_high)
wa_ge$BF <- as.data.frame(ttestBF(x = df_ge$warmth_lo, y = df_ge$warmth_he, paired = TRUE, alternative = "less"))[[1]]

#Mexico
wa_me <- as.data.frame(report::report(t.test(df_me$warmth_lo, df_me$warmth_he, paired = TRUE, alternative = "less")))
wa_me <- wa_me %>% select(p, Cohens_d, Cohens_d_CI_low, Cohens_d_CI_high)
wa_me$BF <- as.data.frame(ttestBF(x = df_me$warmth_lo, y = df_me$warmth_he, paired = TRUE, alternative = "less"))[[1]]
...
```{r}
#all
co_all <- as.data.frame(report::report(t.test(df_all$competence_lo, df_all$competence_he, paired = TRUE, alternative = "less")))
co_all <- co_all %>% select(p, Cohens_d, Cohens_d_CI_low, Cohens_d_CI_high)
co_all$BF <- as.data.frame(ttestBF(x = df_all$competence_lo, y = df_all$competence_he, paired = TRUE, alternative = "less"))[[1]]

#Germany
co_ge <- as.data.frame(report::report(t.test(df_ge$competence_lo, df_ge$competence_he, paired = TRUE, alternative = "less")))
co_ge <- co_ge %>% select(p, Cohens_d, Cohens_d_CI_low, Cohens_d_CI_high)
co_ge$BF <- as.data.frame(ttestBF(x = df_ge$competence_lo, y = df_ge$competence_he, paired = TRUE, alternative = "less"))[[1]]

#Mexico
co_me <- as.data.frame(report::report(t.test(df_me$competence_lo, df_me$competence_he, paired = TRUE, alternative = "less")))
co_me <- co_me %>% select(p, Cohens_d, Cohens_d_CI_low, Cohens_d_CI_high)
co_me$BF <- as.data.frame(ttestBF(x = df_me$competence_lo, y = df_me$competence_he, paired = TRUE, alternative = "less"))[[1]]
