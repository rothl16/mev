...
plot_cg <- plot_violin_with_means(df_plot, c("core_good_he", "core_good_lo"), "core goodness")

plot_vc <- plot_violin_with_means(df_plot, c("value_comm_he", "value_comm_lo"), "value commitment")

plot_pd <- plot_violin_with_means(df_plot, c("pay_deservingness_he", "pay_deservingness_lo"),"pay deservingness")

plot_wa <- plot_violin_with_means(df_plot, c("warmth_he", "warmth_lo"), "warmth")

plot_co <- plot_violin_with_means(df_plot, c("competence_he", "competence_lo"), "competence")
