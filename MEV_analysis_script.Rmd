...
vc_ne$BF <- as.data.frame(ttestBF(x = df_ne$value_comm_lo, y = df_ne$value_comm_he, paired = TRUE))[[1]]
...
vc_sa$BF <- as.data.frame(ttestBF(x = df_sa$value_comm_lo, y = df_sa$value_comm_he, paired = TRUE))[[1]]
...
pd_ne$BF <- as.data.frame(ttestBF(x = df_ne$pay_deservingness_lo, y = df_ne$pay_deservingness_he, paired = TRUE))[[1]]
...
pd_sa$BF <- as.data.frame(ttestBF(x = df_sa$pay_deservingness_lo, y = df_sa$pay_deservingness_he, paired = TRUE))[[1]]
...
wa_ne$BF <- as.data.frame(ttestBF(x = df_ne$warmth_lo, y = df_ne$warmth_he, paired = TRUE))[[1]]
...
wa_sa$BF <- as.data.frame(ttestBF(x = df_sa$warmth_lo, y = df_sa$warmth_he, paired = TRUE))[[1]]
...
co_ne$BF <- as.data.frame(ttestBF(x = df_ne$competence_lo, y = df_ne$competence_he, paired = TRUE))[[1]]
...
co_sa$BF <- as.data.frame(ttestBF(x = df_sa$competence_lo, y = df_sa$competence_he, paired = TRUE))[[1]]
...
#netherlands
m0 <- lm(core_good_diff ~ 1, data = df_ne)
m1 <- lm(core_good_diff ~ Age, data = df_ne)
m2 <- lm(core_good_diff ~ poly(Age,2,raw=TRUE), data = df_ne)
...
#netherlands
m0 <- lm(value_comm_diff ~ 1, data = df_ne)
m1 <- lm(value_comm_diff ~ Age, data = df_ne)
m2 <- lm(value_comm_diff ~ poly(Age,2,raw=TRUE), data = df_ne)
